...
public interface MenuResourceService {
	 ...
	 * @throws Exception
	 */
	public List<MenuResource> getAppAllMenuResourceTree(String systemId) throws Exception;
	 ...
	 * @param appType  0:web 1:app
	 * @param menuType 0:菜单 (模块)1:按钮
	 * @return
	 */
